...
def power_sum(x, n):
  ...
  return power_sum_help(x, n, 1)
  
def power_sum_help(x, n, num):
  ...
  return power_sum_help(x - num**n, n, num + 1) + power_sum_help(x, n, num + 1)
...
if __name__ == "__main__":
  ...
  print(power_sum(100, 2)) # 3 possible combonations
